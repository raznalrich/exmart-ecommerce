...
@Component({
  ...
  imports: [RouterOutlet, HomepageComponent, UsernavbarComponent, SidebarComponent, ProductlistComponent, ThankyoupageComponent, AddButtonComponent, SingleproductpageComponent, AddtocartpageComponent, UsersidebarComponent, NewAddressComponent, SelectAddressComponent, UserOrdersComponent, HomeStaticComponent],
